...
public class Controllerss {
    ...
    public ResponseEntity<?> updateChannel(@PathVariable int channelId,
                                           @RequestParam(required = false) String name) {
        boolean updated = channelService.updateChannels(channelId, name);
    ...
    public ResponseEntity<?> getChannelsByInvitedUser(@PathVariable Long userId) {
    ...
    @PostMapping("/message/sendToChannel/{senderId}/{channelId}")
    public ResponseEntity<?> sendMessageToChannel(@PathVariable int senderId, @PathVariable int channelId, @RequestBody String content) {
        Message message = messageService.sendMessageToChannel(senderId, channelId, content);
        return AppResponse.success().withData(message).withMessage("Message sent to channel successfully").build();
    }
